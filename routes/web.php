...
Route::get('/admin/historiales', [App\Http\Controllers\HistorialController::class, 'index'])->name('admin.historiales.index')->middleware('auth','can:admin.historiales.index');
Route::get('/admin/historiales/create', [App\Http\Controllers\HistorialController::class, 'create'])->name('admin.historiales.create')->middleware('auth','can:admin.historiales.create');
Route::post('/admin/historiales/create', [App\Http\Controllers\HistorialController::class, 'store'])->name('admin.historiales.store')->middleware('auth','can:admin.historiales.store');
Route::get('/admin/historiales/{id}', [App\Http\Controllers\HistorialController::class, 'show'])->name('admin.historiales.show')->middleware('auth','can:admin.historiales.show');
Route::get('/admin/historiales/{id}/edit', [App\Http\Controllers\HistorialController::class, 'edit'])->name('admin.historiales.edit')->middleware('auth','can:admin.historiales.edit');
Route::put('/admin/historiales/{id}', [App\Http\Controllers\HistorialController::class, 'update'])->name('admin.historiales.update')->middleware('auth','can:admin.historiales.update');
Route::get('/admin/historiales/{id}/confirm-delete', [App\Http\Controllers\HistorialController::class, 'confirmDelete'])->name('admin.historiales.confirmDelete')->middleware('auth','can:admin.historiales.confirmDelete');
Route::delete('/admin/historiales/{id}', [App\Http\Controllers\HistorialController::class, 'destroy'])->name('admin.historiales.destroy')->middleware('auth','can:admin.historiales.destroy');
Route::get('/admin/historiales/{id}/pdf', [App\Http\Controllers\HistorialController::class, 'pdfHistorial'])->name('admin.historiales.pdf')->middleware('auth','can:admin.historiales.pdf');

// Búsqueda de paciente por CI y PDF completo del paciente
Route::get('/admin/historial/buscar-paciente', [App\Http\Controllers\HistorialController::class, 'buscarPaciente'])->name('admin.historiales.buscar_paciente')->middleware('auth','can:admin.historiales.buscar_paciente');
Route::get('/admin/historial/pdf-paciente/{id}', [App\Http\Controllers\HistorialController::class, 'pdfPaciente'])->name('admin.historiales.pdf_paciente')->middleware('auth','can:admin.historiales.pdf_paciente');
...
Route::get('/admin/pagos/{id}/pdf', [App\Http\Controllers\PagoController::class, 'pdfPago'])->name('admin.pagos.pdf')->middleware('auth','can:admin.pagos.pdf');
