...
class ConfiguracioneController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.configuraciones.index')
            ->with('mensaje', 'La configuración se ha creado exitosamente')
            ->with('icono', 'success');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.configuraciones.index')
            ->with('mensaje', 'La configuración se ha actualizado exitosamente')
            ->with('icono', 'success');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.configuraciones.index')
            ->with('mensaje', 'La configuración se ha eliminado exitosamente')
            ->with('icono', 'success');
    }
}
