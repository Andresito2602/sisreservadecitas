...
class PacienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pacientes.index')
            ->with('mensaje', 'El paciente se ha creado exitosamente')
            ->with('icono', 'success');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.pacientes.index')
            ->with('mensaje', 'El paciente se ha actualizado exitosamente')
            ->with('icono', 'success');
    }
    ...
    public function destroy($id)
    {
        Paciente::destroy($id);
        return redirect()->route('admin.pacientes.index')
            ->with('mensaje', 'El paciente se ha eliminado exitosamente')
            ->with('icono', 'success');
    }
}
