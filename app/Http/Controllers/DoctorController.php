...
class DoctorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.doctores.index')
            ->with('mensaje', 'El doctor se ha creado exitosamente')
            ->with('icono', 'success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.doctores.index')
            ->with('mensaje', 'El doctor se ha actualizado exitosamente')
            ->with('icono', 'success');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.doctores.index')
            ->with('mensaje', 'El doctor se ha eliminado exitosamente')
            ->with('icono', 'success');
    }
