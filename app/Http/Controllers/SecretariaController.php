...
class SecretariaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.secretarias.index')
            ->with('mensaje', 'La secretaria se ha creado exitosamente')
            ->with('icono', 'success');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.secretarias.index')
            ->with('mensaje', 'La secretaria se ha actualizado exitosamente')
            ->with('icono', 'success');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.secretarias.index')
            ->with('mensaje', 'La secretaria se ha eliminado exitosamente')
            ->with('icono', 'success');
    }
}
