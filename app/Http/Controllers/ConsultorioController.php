...
class ConsultorioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.consultorios.index')
            ->with('mensaje','Se registro el consultorio exitosamente')
            ->with('icono','success');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.consultorios.index')
            ->with('mensaje','Se actualizó el consultorio exitosamente')
            ->with('icono','success');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.consultorios.index')
            ->with('mensaje','Se elimino el consultorio exitosamente')
            ->with('icono','success');
    }
}
