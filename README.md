...
### ⚙️ Configuraciones
Datos institucionales de la clínica (nombre, dirección, teléfono, correo y logo) utilizados en el encabezado de todos los documentos PDF generados por el sistema y en la interfaz del panel de administración.
...
El sistema cuenta con un panel de administración moderno con sidebar oscuro, tipografía Inter y Playfair Display, cards de estadísticas con borde de color, y dashboard con saludo personalizado por usuario y rol. El logo y nombre de la clínica se toman automáticamente del módulo de configuraciones.
