                ...
                <div class="card-body">
                    <form action="{{url('/admin/pacientes',$paciente->id)}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    <label for="">Nro de documento</label> <b>*</b>
                                    <input type="number" value="{{$paciente->cc}}" name="cc" class="form-control" required>
                                    @error('cc')
                                    <small style="color:red">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <input type="number" value="{{$paciente->nro_seguro}}" name="nro_seguro" class="form-control" required>
                                    @error('nro_seguro')
                                    <small style="color:red">{{$message}}</small>
                                    @enderror
                                </div>
