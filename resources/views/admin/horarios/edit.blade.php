...
@section('content')
    <div class="row">
        <h1>Actualización del horario: {{$horario->doctor->nombres." ".$horario->doctor->apellidos." ".$horario->consultorio->nombre." - ".$horario->consultorio->ubicacion." ".$horario->dia." ".$horario->hora_inicio." - ".$horario->hora_fin}}</h1>
    </div>
                                    ...
                                    <div class="form group">
                                        ...
                                        <script>
                                            ...
                                            $(document).ready(function() {
                                                $('#consultorio_select').trigger('change');
                                            });
                                        </script>
                                    </div>
                                </div>
                                    ...
                                    <div class="form group">
                                        ...
                                        <select name="doctor_id" id="" class="form-control">
                                            @foreach($doctores as $doctore)
                                                <option value="{{ $doctore->id }}"{{ $horario->doctor_id == $doctore->id ? 'selected' : '' }}>{{ $doctore->nombres." ".$doctore->apellidos." - ".$doctore->especialidad }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
