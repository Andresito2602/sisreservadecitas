...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // rutas para el historial medico
        Permission::create(['name'=>'admin.historiales.index'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.create'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.store'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.show'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.edit'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.update'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.confirmDelete'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.destroy'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.pdf'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.buscar_paciente'])->syncRoles([$admin,$doctor]);
        Permission::create(['name'=>'admin.historiales.pdf_paciente'])->syncRoles([$admin,$doctor]);
